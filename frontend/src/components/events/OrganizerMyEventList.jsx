...
const OrganizerMyEventList = ({ userMode }) => {
    ...
    const loadEvents = useCallback(async () => {
        ...
        try {
            ...
            console.log("everything", initialData, "the ids", allEventIds)
            ...
            const organizedEvents = allDetailedEvents.filter(event => {
                ...
                return event.organizers?.some(organizer => {
                    ...
                    const organizerUtorid = organizer.utorid;
                    const organizerId = organizer.id;

                    return organizerUtorid === user.utorid || organizerId === user.id;
                });
...
export default OrganizerMyEventList;